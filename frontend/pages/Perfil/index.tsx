...
import LogoutModal from "@/frontend/components/Modals/ModalLogout"
import EditarInfoModal from "@/frontend/components/Modals/ModalEditarNome"
...
const PaginaPerfil = () => {
  ...
  const TemaCard = ({ nome, cor, botao = false, onPress, ativo = true }: TemaCardProps) => {
    ...
    const Conteudo = () => (
      <>
        <Text style={[styles.retangulo_tema_escrito, textBg, textColor]}>{nome}</Text>
        ...
        {loading ? (
          ...
          <ScrollView contentContainerStyle={{ paddingBottom: 140 }}>
            <View style={styles.cima_logout}>
              <TouchableOpacity
                style={styles.botao_logout}
                onPress={() => setLogoutModalActive(true)}
              >
            ...
            <View style={styles.informacoes}>
              ...
              <View style={styles.parte_input}>
                ...
                <View style={styles.tema_wrapper}>
                  ...
                  <TouchableOpacity
                    style={[styles.botao_editar, getTemaBgStyle(temaAtual, "primario")]}
        ...
        >
          <View style={styles.modal_container_descricao}>
            <View style={styles.detalhe_cima}>
              <Text style={[globalStyles.titulo, styles.titulo_menor]}>Cor Tema da Conta</Text>
            ...
            <View style={styles.parte_baixo}>
              <TouchableOpacity
                style={[globalStyles.botao_primario, styles.mesma_largura]}
                onPress={salvarTema}
              >
                {loadingModal ? (
